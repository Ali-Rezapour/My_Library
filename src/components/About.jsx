            ...
            <div className="contact">
                <main>
                    <section>
                        <div className="content">
                            <img src="https://www.snapptrip.com/blog/wp-content/uploads/2021/11/Stockholm-Public-Library-Alamy.jpg" alt="Profile Image"/>

                                <aside>
                                    <h1> کتابخانه من </h1>
                                    <p>کتابخانه ما با بیشتر از هزاران کتاب معروف درسی و غیر درسی است.</p>
                                </aside>
                        ...
                        <div className={`title ${expand}`}><p>ارتباط با ما</p></div>
                    </section>
                ...
                <nav className={expand}>
                    <a href="#" className="gmail">
                        ...
                        <div className="content">
                            <h1>ایمیل</h1>
                            <span>mylibrary@gmail.com</span>
                        </div>

                        <svg className="arrow" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                            <g className="nc-icon-wrapper" fill="#444444">
